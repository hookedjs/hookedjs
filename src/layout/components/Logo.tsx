import {useState} from '#src/lib/hooks'
      ...
      <div
        style={{
          ...
          backgroundImage: `url('data:image/svg+xml;base64,${btoa(
            rockyBorderSvg(colors.borderColor, colors.innerColor),
          )}')`,
        }}>
        Stacks!
      </div>
